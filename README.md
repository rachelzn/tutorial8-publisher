...
The chart in the image represents the publisher's activity in sending out messages. By monitoring the 'message rates last minute', we can determine whether the publisher is under a heavy or light load in message transmission. This assists in understanding the volume of message delivery and processing taking place.
<img width="1512" alt="Screenshot 2024-04-23 at 01 02 54" src="https://github.com/rachelzn/tutorial8-publisher/assets/92985397/1ad3540c-2e86-4cc6-a8e1-89ddaa45621a">
